...
import "../secretary/secretaryanointingofthesickview.css";

const AnointingOfTheSickView = () => {
  ...
  const renderSuccessModal = () => {
    ...
    return (
      <div className="secretary-anointing-document-viewer-overlay">
        <div className={`secretary-anointing-${modalType}-modal-container`}>
          <div className={`secretary-anointing-${modalType}-header`}>
          ...
          <div className={`secretary-anointing-${modalType}-content`}>
            <div className={`secretary-anointing-${modalType}-icon`}>
              {isSuccess ? "✓" : "!"}
            </div>
            <p>{successMessage}</p>
            <button 
              className={`secretary-anointing-${modalType}-ok-btn`}
              onClick={handleOkClick}
            >
              OK
            </button>
  ...
  const renderConfirmModal = () => {
    ...
    return (
      <div className="secretary-anointing-document-viewer-overlay">
        <div className="secretary-anointing-confirm-modal-container">
          <div className="secretary-anointing-confirm-header">
          ...
          <div className="secretary-anointing-confirm-content">
            <div className="secretary-anointing-confirm-icon">?</div>
            ...
            <div className="secretary-anointing-confirm-buttons">
              <button 
                className="secretary-anointing-confirm-yes-btn"
                onClick={handleConfirmApproval}
              >
                Yes, Approve
              </button>
              <button 
                className="secretary-anointing-confirm-no-btn"
                onClick={() => setShowConfirmModal(false)}
              >
                Cancel
              </button>
  ...
  return (
    <div className="secretary-anointing-view-container">
      ...
      <div className="secretary-anointing-view-data">
        ...
        <div className="secretary-anointing-action-buttons">
          {status !== "Approved" && (
            <button 
              className="secretary-anointing-submit-button"
...
export default AnointingOfTheSickView;