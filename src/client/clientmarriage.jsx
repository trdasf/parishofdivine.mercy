     ...
     if (response.data.success) {
       ...
       try {
         const emailResponse = await axios.post(
           'http://parishofdivinemercy.com/backend/send_marriage_email.php',
           {
             clientID: clientID,
             marriageData: applicationData
           }
         );
         console.log('Email response:', emailResponse.data);
       } catch (emailError) {
         console.log('Email sending failed, but application was submitted successfully:', emailError);
