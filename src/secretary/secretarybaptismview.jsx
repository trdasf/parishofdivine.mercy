    ...
    <div className="secretary-baptism-view-container">
      ...
      <div className="secretary-baptism-view-header">
        <div className="secretary-view-left-section">
          <button className="secretary-view-back-button" onClick={() => window.history.back()}>
            <AiOutlineArrowLeft className="secretary-view-back-icon" /> Back
          </button>
        </div>
        <div className="secretary-view-right-section">
          <div className="secretary-view-status-selector">
            <label htmlFor="status-select">Status:</label>
            <select 
              id="status-select" 
              className="secretary-status-dropdown"
              value={status}
      ...
      <div className="secretary-baptismal-view-data">
        ...
        <div className="secretary-view-bypart">
          ...
          <div className="secretary-baptismal-view-info-card">
            ...
            <div className="secretary-baptismal-view-row">
              <div className="secretary-baptismal-view-field-ga">
                <label>Age:</label>
          ...
          <div className="secretary-baptismal-view-info-card">
            ...
            <div className="secretary-baptismal-view-row">
            <div className="secretary-baptismal-view-field-fpob">
            ...
            <div className="secretary-baptismal-view-row-pms">
              <div className="secretary-marital-view-status">
                ...
                <div className="secretary-marital-view-options">
                  <div className="secretary-view-pms-label">
                    <span className={`secretary-view-checkbox ${baptismData.maritalStatus.type === 'Catholic' ? 'secretary-view-checked' : ''}`}></span>
        ...
        <div className="secretary-requirements-view-container">
          ...
          <div className="secretary-requirements-view-box">
            <h3 className="secretary-view-section-header">Documents Status</h3>
            <div className="secretary-view-checkbox-list">
              {/* Birth Certificate */}
              <div className="secretary-requirement-view-item">
                <div className="secretary-view-requirement-name">
        ...
        <div className="secretary-action-buttons">
          ...
          <button 
            className="secretary-cancel-button"
