...
import "../../client/ClientBaptism.css";
...
const Baptism = () => {
  ...
  const handleYes = async () => {
    ...
    try {
      ...
      // Submit the form
      const response = await fetch('http://parishofdivinemercy.com/backend/sec_baptism_application.php', {
        method: 'POST',
        body: formDataToSend
      });
  ...
  return (
    <div className="client-baptism-container">
      ...
      <h3 className="client-section-header">Documents Required</h3>
