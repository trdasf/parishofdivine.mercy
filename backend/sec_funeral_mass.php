...
try {
    ...
    try {
        ...
        // Insert into funeral_mass_application table - removed clientID
        ...
        $stmt->bind_param("ss", 
            $_POST['dateOfFuneralMass'], $_POST['timeOfFuneralMass']
        );
        ...
        // Insert into deceased_info table
        ...
        // Insert into requester_info table
        ...
        // Insert into deceased_address table
        ...
        // Create a burial_requirements record
