    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
                    ...
                    <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>
                        ...
                        <div style='padding: 30px 20px; background-color: #fff;'>
                            ...
                            <div style='background-color: #f9f9f9; padding: 20px; border-radius: 8px; margin: 25px 0; border-left: 4px solid #28a745;'>
                                <h3 style='color: #573901; font-family: Montserrat, sans-serif; margin-top: 0; font-size: 18px;'>Anointing Details:</h3>
                            ...
                            <p style='color: #000; font-family: Roboto, sans-serif; font-size: 16px; margin-top: 20px;'>A priest from our parish will visit the location at the scheduled time. Please ensure someone will be available to receive the priest.</p>
                            ...
                            <p style='color: #000; font-family: Roboto, sans-serif; font-size: 16px; margin-top: 30px;'>If you have any questions or need to make changes to the appointment, please contact our parish office.</p>
                            
                            <p style='color: #000; font-family: Roboto, sans-serif; font-size: 16px; margin-top: 40px;'>God bless,<br><strong style='color: #573901;'>Parish of Divine Mercy</strong><br>Anointing Ministry</p>
                        </div>
            ...
            $mail->AltBody = "Dear {$fullName},\n\n" .
                ...
                "Status: APPROVED\n\n" .
                "A priest from our parish will visit the location at the scheduled time. Please ensure someone will be available to receive the priest.\n\n" .
