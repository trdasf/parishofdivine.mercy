...
try {
    ...
    try {
        ...
        // Insert into baptism_application table (with region added)
        $sql = "INSERT INTO baptism_application (
            clientID, dateOfBaptism, timeOfBaptism, priestName,
        ...
        $stmt->bind_param("isssssssssss", 
            $clientID, $_POST['dateOfBaptism'], $_POST['timeOfBaptism'], 
