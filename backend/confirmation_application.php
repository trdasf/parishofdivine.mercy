...
try {
    ...
    // Insert into confirmation_application
    $stmt = $conn->prepare("INSERT INTO confirmation_application (clientID, date, time, priest, first_name, middle_name, last_name, gender, age, dateOfBirth, dateOfBaptism, churchOfBaptism, placeOfBirth, status) 
                           VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'Pending')");
